# This code is meant to find the k-edge-connected component of graph G
#  We use a global cut algorithm to find a cut of size k and then apply
#  the cut, until there is no such cut left in the network
